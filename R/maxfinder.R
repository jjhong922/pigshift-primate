...
modellist[[1]] <- "Human-to-anc"; modellist[[2]] <- "Chimp-to-anc"; modellist[[3]] <- "HCanc-to-anc";
 modellist[[4]] <- "Gorilla-to-anc"; modellist[[5]] <- "HCGanc-to-anc"; modellist[[6]] <- "Orang-to-anc"; modellist[[7]] <- "HCGOanc-to-anc"; modellist[[8]] <- "Monkey-to-anc"; modellist[[9]] <- "OU"
